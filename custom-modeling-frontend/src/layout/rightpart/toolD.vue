  ...
  methods: {
    ...
    flash() {
      ...
      if (this.leftNode) {
        ...
        this.optionsLeft = this.leftNode.data_state.field.filter(it => it.checked === "true");
      } else {
        this.left = "None";
        this.optionsLeft = [];
      ...
      if (this.rightNode) {
        ...
        this.optionsRight = this.rightNode.data_state.field.filter(it => it.checked === "true");
      } else {
        this.right = "None";
        this.optionsRight = [];
      ...
      if(this.leftNode){
        this.$set(this.item.data_state,'field', this.leftNode.data_state.field.filter(it => it.checked === "true").concat(this.rightNode.data_state.field.filter(it => it.checked === "true")) || []);
      }
      else {
        this.$set(this.item.data_state,'field', this.rightNode.data_state.field.filter(it => it.checked === "true") || []);
      }
    ...
    async handle_exec(){
      ...
      this.addPreShowTitles([{
        ...
        let payload = {
            ...
            table_header: this.leftNode.data_state.field.filter(it => it.checked === "true").concat(this.rightNode.data_state.field.filter(it => it.checked === "true")),
            table_data: res.data,          
        };
        this.openTable();
        this.countDataNum();
